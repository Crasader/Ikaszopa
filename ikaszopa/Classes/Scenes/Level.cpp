...
bool Level::init()
{
    ...
    buttonSFXSettings->setTag(static_cast<int>(SceneType::SETTINGS));
...
//    vector<SubCategory*> subCategories = categories.at(GamePlayPointsManager::getInstance()->getCurrentCategory())->getSubCategories();
